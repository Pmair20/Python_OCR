...
import pytesseract
import numpy as np
pytesseract.pytesseract.tesseract_cmd = r'D:\Python_Codes/tesseract.exe'       # path to the tesseract exe after installing from the link mentioned in setup_link txt
img = cv2.imread('D:\Python_Codes/trial.png')                                  # path to the text image to use OCR
